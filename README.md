...
- De la tension et un compte à rebours dramatique
- Le plaisir de coopérer et résoudre ensemble
...
- Suivre un timer visuel basé sur la lune qui s’assombrit par un bouton (comme dans le film)
- Sauver Wybie emprisonné dans un tableau
...
4. Narration dynamique : la projection de Wybie qui demande de l’aide
5. Ambiance immersive : sons, lumière jaune, bleutée/mauve, objets du film
...
- Les boutons noirs en gros plan (symbole mère méchante)
- Le monde « autre » (couleurs saturés, ambiance étranges et objets trop parfaits)
- La chambre de Coraline (murs roses/mauves, objets vivants)
...
- Une expérience collaborative parfait pour des groupes
...
- Budget, calendrier, approbation du concept
...
- Correction des bugs
- Amélioration de l’expérience sonore/visuelle
...
- Forte immersion esthétique
- Narration active (un personnage demande de l’aide et un autre donne des indices)
- Énigmes variées et accessibles

Pourquoi ça attire des investisseurs Kickstarter :
- Concept original et fort potentiel viral
- Public large : familles, fans de Coraline, amateurs d’escape games
